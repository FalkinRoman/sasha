...
@section('content')
    <div class="mx-auto max-w-2xl text-center">
        ...
        <p data-pv-reveal class="pv-reveal pv-reveal--fade mt-4 text-lg text-[#7a837a]" style="--rv-delay: 0.1s">Доступ по тарифу «{{ $purchase->tariff->name }}» активен до {{ $purchase->expires_at?->translatedFormat('d F Y') }}.</p>
