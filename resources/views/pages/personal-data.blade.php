    ...
    <article class="mx-auto max-w-2xl px-5 py-16 sm:px-8 lg:px-12">
        <div data-pv-reveal class="pv-reveal pv-reveal--up">
            ...
            <div class="mt-10 space-y-6 text-[#5c655c] leading-relaxed">
                ...
                <p>Согласие можно отозвать, написав на <a href="mailto:support@prostoyoga.ru" class="text-[#869274] underline underline-offset-2 hover:text-[#2d312d]">support@prostoyoga.ru</a>. Отзыв не влияет на законность обработки до момента отзыва.</p>
            </div>
        </div>
    </article>
@endsection
