    ...
    <article class="mx-auto max-w-2xl px-5 py-16 sm:px-8 lg:px-12">
        <div data-pv-reveal class="pv-reveal pv-reveal--up">
            ...
            <ul class="mt-10 space-y-4 text-[#2d312d]">
                <li><strong class="text-[#869274]">Email:</strong> <a href="mailto:support@prostoyoga.ru" class="text-[#869274] underline underline-offset-2 hover:text-[#2d312d]">support@prostoyoga.ru</a></li>
                <li><strong class="text-[#869274]">Telegram:</strong> <a href="https://t.me/prostoyoga" target="_blank" rel="noopener" class="text-[#869274] underline underline-offset-2 hover:text-[#2d312d]">@prostoyoga</a> (будни, 10:00–19:00 МСК)</li>
            </ul>
